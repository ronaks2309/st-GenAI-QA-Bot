...
st.set_page_config(
    page_title="WMC Data Visualizations playground",
    page_icon="📊",
)

st.subheader("WMC Data Visualizations Playground 📊")
...
#        st.sidebar.write("### Goal Selection")
        ...
        selected_goal = st.selectbox('Choose a generated insight', options=goal_questions, index=0)
